...
add_action( 'customize_register', function( $wp_customize ) {
	...
	$wp_customize->add_control( 'thumbnail_layout', array(
		...
		'choices'	=> array(
			...
			'under'	=> __( 'Text below the image', 'luxeritas' )
		),
		'priority'	=> 15
	));
	...
	$wp_customize->add_control( 'thumbnail_is_size', array(
		...
		'description'	=> '<p class="m0b">' . __( 'Normal style', 'luxeritas' ) . '</p>',
		'section'	=> 'thumbnail_section',
		'type'		=> 'select',
		'choices'	=> array(
			'generate'	=> __( 'Thumbnails created below', 'luxeritas' ),
			'thumbnail'	=> 'normal ( 150px )',
			'medium'	=> 'medium ( 300px )',
			'large'		=> 'large ( 640px )',
			'full'		=> 'full ( ' . __( 'Original size', 'luxeritas' ) . ' )'
		),
		'priority'	=> 20
	));
	...
	$wp_customize->add_control( 'thumbnail_is_size_tile', array(
		...
		'choices'	=> array(
			'generate'	=> __( 'Thumbnails created below', 'luxeritas' ),
			'thumb320'	=> 'tile ( 320 x 180px crop )',
			'thumbnail'	=> 'normal ( 150px )',
			'medium'	=> 'medium ( 300px )',
			'large'		=> 'large ( 640px )',
			'full'		=> 'full ( ' . __( 'Original size', 'luxeritas' ) . ' )'
	...
	$wp_customize->add_control( 'thumbnail_tile_width_full', array(
		...
		'label'		=> __( 'Full width', 'luxeritas' ) . ' ( width: 100% )',
		'section'	=> 'thumbnail_section',
		'type'		=> 'checkbox',
		'priority'	=> 22
	));
	...
	$wp_customize->add_control( 'thumbnail_tile_align_center', array(
		...
		'label'		=> __( 'Align center', 'luxeritas' ) . ' ( align: center )',
		'section'	=> 'thumbnail_section',
		'type'		=> 'checkbox',
		'priority'	=> 23
	));
	...
	$wp_customize->add_control( 'thumbnail_is_size_card', array(
		...
		'choices'	=> array(
			'generate'	=> __( 'Thumbnails created below', 'luxeritas' ),
			'thumb75'	=> 'card mini ( 75 x 75px crop )',
			'thumb100'	=> 'card ( 100 x 100px crop )',
			'thumbnail'	=> 'normal ( 150px )',
			'medium'	=> 'medium ( 300px )',
		),
		'priority'	=> 24
	...
	$wp_customize->add_control( 'thumbnail_width', array(
		...
		'label'		=> '',
		'description'	=> '<p class="f11em bold snormal">' . __( 'Thumbnail size that would be auto created when registered in Media Library', 'luxeritas' ) . '</p><p class="f09em">' . __( '* It will create the thumbnail in the below size.', 'luxeritas' ) . '</p><p class="f09em">' . __( '* It will auto create a small thumbnail with a size of 66.6&#x25; for small devices.', 'luxeritas' ) . '</p><p class="f09em">' . __( '* Pre registered images will not be auto generating the thumbnails.  For such purpose, please use plugins that will allow to re-generate thumbnails from your whole Media Library.', 'luxeritas' ) . '</p><p class="f11em bold snormal">' . __( 'Width of image', 'luxeritas' ) . ' (' . __( 'default', 'luxeritas' ) . ': 150px)</p>',
		'section'	=> 'thumbnail_section',
		'type'		=> 'number',
		'priority'	=> 25
	));
	...
	$wp_customize->add_control( 'thumbnail_height', array(
		...
		'label'		=> __( 'Height of image', 'luxeritas' ) . ' (' . __( 'default', 'luxeritas' ) . ': 150px)',
		'section'	=> 'thumbnail_section',
		'type'		=> 'number',
		'priority'	=> 30
	));
	...
	$wp_customize->add_control( 'thumbnail_view_height', array(
		...
		'label'		=> __( 'The height used in actual page', 'luxeritas' ),
		'section'	=> 'thumbnail_section',
		'type'		=> 'select',
		'choices'	=> array(
			'auto'	=> __( 'Keep the aspect ratio', 'luxeritas' ),
			'fixed'	=> __( 'Fixed (apply the height input above)', 'luxeritas' )
		),
		'priority'	=> 35
	));
...
*/
	...
	$wp_customize->add_control( 'lazyload_enable', array(
		...
		'label'		=> __( 'Enable Lazy Load for post and pages.', 'luxeritas' ),
		'description'	=> '<p class="f09em mm10b mm23l">' . __( '* srcset of the posts will be disabled.', 'luxeritas' ) . '</p>',
	...
	$wp_customize->add_control( 'lazyload_enable', array(
		'settings'	=> 'lazyload_enable',
		'label'		=> __( 'Enbale Lazy Load for post and pages.', 'luxeritas' ),
		'description'	=> '<p class="f09em mm10b mm23l">' . __( '* srcset of the posts will be disabled.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'checkbox',
		'priority'	=> 10
	...
	$wp_customize->add_control( 'lazyload_crawler', array(
		...
		'label'		=> __( 'Disable Lazy Load for search engine crawlers', 'luxeritas' ),
		'description'	=> '<p class="f09em mm23l">' . __( '* minor search engies are not supported.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'checkbox',
		'priority'	=> 15
	));
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'lazyload_placeholder', array(
		...
		'label'		=> __( 'Color of the placeholder', 'luxeritas' ),
		'description'	=> '<p class="f09em">' . __( '* Placeholder is an image which will be temporarily displayed until full image is displayed.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'priority'	=> 20
	) ) );
	...
	$wp_customize->add_control( 'lazyload_spinner', array(
		...
		'label'		=> __( 'Add spinner to placeholder', 'luxeritas' ),
		'description'	=> '<p class="f09em mm10b mm23l">' . __( '* Spinner is the spinning image which is shown until the full image is displayed.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'checkbox',
		'priority'	=> 25
	));
	...
	$wp_customize->add_control( 'lazyload_threshold', array(
		...
		'label'		=> __( 'threshold amount ( px )', 'luxeritas' ),
		'description'	=> '<p class="f09em">' . __( '* If you want to start loading the images before apperaing, please define the length of pixels outside the viewport.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'number',
		'priority'	=> 30
	));
	...
	$wp_customize->add_control( 'lazyload_effectspeed', array(
		...
		'label'		=> __( 'Speed of Fade-in ( ms )', 'luxeritas' ),
		'description'	=> '<p class="f09em">' . __( '* Unit : milliseconds.', 'luxeritas' ) . '<br />' . __( 'e.g. Input 3000 for 3 seconds.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'number',
		'priority'	=> 40
	));
	...
	$wp_customize->add_control( 'lazyload_event', array(
		...
		'label'		=> __( 'Events', 'luxeritas' ),
		'description'	=> '<p class="f09em">' . __( '* Will display image when following event ocurs.', 'luxeritas' ) . '</p>',
		'section'	=> 'lazyload_section',
		'type'		=> 'radio',
		'choices'	=> array(
			'scroll'	=> 'Scroll',
