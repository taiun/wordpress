...
<?php
	...
	if( isset( $luxe['sns_count_cache_enable'] ) &&
		...
		if( isset( $luxe['feedly_share_bottoms_button'] ) ) {
			$feed_cnt = '<i class="fa fa-spinner fa-spin"></i>';
		}
	}
?>
<div class="<?php echo $cls_div; ?>">
<ul class="<?php echo $cls_lst; ?>">
<?php if( $buttons['twitter'] ) { ?>
<!--twitter-->
<li class="twitter"><a href="//twitter.com/share?text=<?php echo $title; ?>&amp;url=<?php echo THK_HOME_URL; ?>" title="Tweet" target="_blank" rel="nofollow"><i class="fa fa-twitter">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">Twitter</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> twitter-count"><i class="fa fa-commenting-o"></i></span><?php endif; ?><?php endif; ?></a></li>
<?php } if( $curkey === 'twitter' ) echo $pgraph;
	if( $buttons['facebook'] ) { ?>
<!--facebook-->
<li class="facebook"><a href="//www.facebook.com/sharer/sharer.php?u=<?php echo THK_HOME_URL; ?>&amp;t=<?php echo $title; ?>" title="Share on Facebook" target="_blank" rel="nofollow"><i class="fa fa-facebook">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">Facebook</span><?php endif; ?><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> facebook-count"><?php echo $id_cnt['f']; ?></span><?php endif; ?></a></li>
<?php } if( $curkey === 'facebook' ) echo $pgraph;
	if( $buttons['google'] ) { ?>
<!--google+1-->
<li class="google"><a href="//plus.google.com/share?url=<?php echo THK_HOME_URL; ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Google+" target="_blank" rel="nofollow"><i class="fa fa-google-plus">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">Google+</span><?php endif; ?><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> google-count"><?php echo $id_cnt['g']; ?></span><?php endif; ?></a></li>
<?php } if( $curkey === 'google' ) echo $pgraph;
	if( $buttons['linkedin'] ) { ?>
<!--linkedin-->
<li class="linkedin"><a href="//www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo THK_HOME_URL; ?>&amp;title=<?php echo $title; ?>&amp;summary=<?php echo thk_encode( apply_filters( 'thk_create_description', '' ) ); ?>" title="Share on LinkedIn" target="_blank" rel="nofollow"><i class="fa fa-linkedin">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">LinkedIn</span><?php endif; ?><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> linkedin-count"><?php echo $id_cnt['l']; ?></span><?php endif; ?></a></li>
...
<?php } if( $curkey === 'hatena' ) echo $pgraph;
	if( $buttons['pocket'] ) { ?>
<!--pocket-->
<li class="pocket"><a href="//getpocket.com/edit?url=<?php echo THK_HOME_URL; ?>" title="Pocket: Read it Later" target="_blank" rel="nofollow"><i class="fa fa-get-pocket">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">Pocket</span><?php endif; ?><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> pocket-count"><?php echo $id_cnt['p']; ?></span><?php endif; ?></a></li>
<?php } if( $curkey === 'pocket' ) echo $pgraph;
	if( $buttons['line'] ) { ?>
<!--LINE-->
<li class="line line-pc"><a href="//lineit.line.me/share/ui?url=<?php echo rtrim( $permalink, '/' ) ?>/#/" title="<?php echo __( 'Send to LINE', 'luxeritas' ); ?>" target="_blank" rel="nofollow"><i class="ico-line">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">LINE</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?>"><i>Send</i></span><?php endif; ?><?php endif; ?></a></li>
<li class="line line-sm"><a href="//line.me/R/msg/text/?<?php echo $title; ?>%0D%0A<?php echo $permalink; ?>" title="<?php echo __( 'Send to LINE', 'luxeritas' ); ?>" target="_blank" rel="nofollow"><i class="ico-line">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">LINE</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?>"><i>Send</i></span><?php endif; ?><?php endif; ?></a></li>
<?php } if( $curkey === 'line' ) echo $pgraph;
	if( $buttons['rss'] ) { ?>
<!--rss-->
<li class="rss"><a href="<?php echo get_bloginfo('rss2_url'); ?>" title="RSS" target="_blank" rel="nofollow"><i class="fa fa-rss">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">RSS</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> rss-count"><i class="fa fa-rss"></i></span><?php endif; ?><?php endif; ?></a></li>
<?php } if( $buttons['feedly'] ) { ?>
<!--feedly-->
<li class="feedly"><a href="//feedly.com/index.html#subscription/feed/<?php echo rawurlencode( get_bloginfo('rss2_url') ); ?>" title="Feedly" target="_blank" rel="nofollow"><i class="ico-feedly">&nbsp;</i><?php if( $icon_only !== true ): ?><span class="snsname">Feedly</span><?php endif; ?><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> feedly-count"><?php echo $feed_cnt; ?></span><?php endif; ?></a></li>
<?php } ?>
</ul>
<div class="<?php
