...
ob_start();
if( TDEL === SDEL ) {
	if( file_exists( TPATH . DSEP . 'add-analytics.php' ) === true ) {
		require( TPATH . DSEP . 'add-analytics.php' );
	}
}
else {
	if( file_exists( SPATH . DSEP . 'add-analytics.php' ) === true ) {
		require( SPATH . DSEP . 'add-analytics.php' );
	}
}
